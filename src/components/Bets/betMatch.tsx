import useBet from "@/hooks/use-prediction";
    ...
    <View>
      ...
      >
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
          <View style={{ backgroundColor: '#4b4b4bff', padding: 20, borderRadius: 10 }}>

            <Text style={{ color: '#fff', paddingBottom: 25, fontSize: 16, fontWeight: 800 }}>Vamos! Haz tu predicción</Text>

            <View style={styles.teamsRow}>
              <View style={styles.team}>
                <Image source={{ uri: matchId.homeTeam!.flag }} style={styles.flag} />
                <TextInput keyboardType="numeric" value={valueHomeTeam} onChangeText={handleChangeHomeTeamText} style={styles.teamName} placeholder="0" />
              ...
              <View style={styles.teamRight}>
                <TextInput keyboardType="numeric" value={valueAwayTeam} onChangeText={handleChangeAwayTeamText} style={styles.teamName} placeholder="0" />
                <Image source={{ uri: matchId.awayTeam.flag }} style={styles.flag} />
              </View>
            </View>
            ...
            <View style={styles.metaRow}>
              <Button title="Apostar" color='#298a3eff' onPress={() => {
                
                toBet(matchId, parseInt(valueHomeTeam),parseInt(valueAwayTeam));
                onClose()
              }} />
...
const styles = StyleSheet.create({
  ...
  teamsRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 20 },
  ...
  teamName: { backgroundColor: '#e6f2ff', fontWeight: '700', marginHorizontal: 8, width: 30 },
