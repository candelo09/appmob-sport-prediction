import { useParticipantGroupstandingByGroup } from "@/hooks/use-participant-group-standing";
...
export default function ParticipantDataTableStanding({
  groupId,
  participantId,
}: Props) {
  const { allGroupStandingByGroup } = useParticipantGroupstandingByGroup(
    participantId,
    groupId,
  );
  ...
  console.log("allGroupStandingByGroup.data ", allGroupStandingByGroup.data);
  ...
  return (
    <DataTable>
      ...
      {allGroupStandingByGroup.data!.map((item, index) => (
